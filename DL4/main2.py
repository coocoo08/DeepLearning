...
output = pd.get_dummies(dataset.output)     # get_dummies() : 가변수(dummy variable)로 만들어주는 함수 (0, 1)
output = output.values
output = torch.tensor(output).flatten()          # 1차원 텐서로 변환
