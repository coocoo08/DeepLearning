...
input_layer_1 = Dense(15, activation='relu')(input_layer)
input_layer_2 = Dense(10, activation='relu')(input_layer_1)
output = Dense(y.shape[1], activation='softmax')(input_layer_2)
...
# 모델 훈련
history = model.fit(X_train, y_train, batch_size=0, epochs=50, verbose=1, validation_split=0.2)
